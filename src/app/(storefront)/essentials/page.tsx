...
const BRAND = "GRABWAY_ESSENTIALS";
    ...
    <div className="container py-8">
      ...
      <div className="mb-8 text-center">
        <div className="flex items-center justify-center mb-4">
          <img
            src="/logos/grabway-essentials.png"
            alt="Grabway Essentials"
      ...
      <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
        ...
        <span>/</span>
        <span className="text-foreground">Grabway Essentials</span>
        {selectedCategory && (
          <>
            <span>/</span>
                ...
                <li>
                  <button
                    ...
                    className={`text-sm w-full text-left py-1.5 px-3 rounded-md transition-colors ${
                      !selectedCategory ? "bg-emerald-100 text-emerald-800 font-medium" : "hover:bg-muted"
                    }`}
                  >
                    All Essentials
                  </button>
        ...
        <div className="flex-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:flex border rounded-md overflow-hidden">
                <button
                  ...
                  className={`p-2 ${viewMode === "grid" ? "bg-emerald-100 text-emerald-700" : ""}`}
                >
                  <Grid3X3 className="h-4 w-4" />
                </button>
                <button
                  onClick={() => setViewMode("list")}
                  className={`p-2 ${viewMode === "list" ? "bg-emerald-100 text-emerald-700" : ""}`}
                >
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-semibold mb-2">No essentials found</h3>
